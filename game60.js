...
function getStats() {
    ...
    return s ? JSON.parse(s) : {
        ...
        gotTonTonTon:false, gotPoisonApple:false, gotFluffyOmelette:false, gotGreenCurry:false, gotTriCaviar:false, gotKaiTate:false,
...
function onCookDone(curry) {
    ...
    const isSpecial = curry.isPoison||curry.isIllusion||curry.isSeed||curry.isMargherita||curry.isSeafood||curry.isTonTonTon||curry.isSticky||curry.isWanpaku||curry.isRatatouille||curry.isHomerun||curry.isFluffyOmelette||curry.isGreenCurry||curry.isTriCaviar||curry.isKaiTate;
...
function buildCurryFromMaterials(materialNames, spiceName) {
    ...
    isPoison=false; isMargherita=false; isTonTonTon=false; isIllusion=false; isSticky=false; isSeed=false; isWanpaku=false; isRatatouille=false; isHomerun=false; isPoisonApple=false; isFluffyOmelette=false; isGreenCurry=false; isTriCaviar=false; isKaiTate=false;
